    ...
    <div id="sub_content">
        ...
        <div class="row mb-4">
            ...
            <label for="email" class="col-md-2 col-form-label">Name</label>
                    <div class="col-md-4">
                <input type="text" class="form-control" id="email" value="${currentUser.name }" name="name">
            </div>
        ...
        <div class="row mb-4">
            ...
            <div class="col-md-4">
                <input type="password" class="form-control" id="name" value="${currentUser.password }" name="password">
            </div>
        ...
        <div class="row mb-4">
            ...
            <div class="col-md-4">
                <input type="password" class="form-control" id="confirmPassword" value="${currentUser.password }" name="confirmPassword">
            </div>
