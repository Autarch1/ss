    ...
    <div id="sub_content">
        <form action="StudentRegistrationUpdate" method = "post">
            ...
            <fieldset class="row mb-4">
                ...
                <div class="col-md-4">
                 <c:forEach items="${applicationScope.courses}" var="courseName">

                    <div class="form-check-inline col-md-2">
                        <input class="form-check-input" type="checkbox" name="courses" id="gridRadios1" value="option1">
                        <label class="form-check-label" for="${courseName}">
                           ${courseName}
